class EpicsController < ApplicationController
  ...
  private
    ...
    def epic_params
      params.require(:epic).permit(:rpt_date, :epic_key, :effort_tracking, :epic_name, :epic_component, :effort_original, :effort_remaining, :effort_spent, :effort_changed, :epic_reporter, :epic_type, :epic_assignee, :epic_status)
    end
end
